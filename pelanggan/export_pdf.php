...
$pdf->SetHeaderData('', 0, 'Laporan Pemesanan Properti', 'Dibuat oleh: ' . $_SESSION['nama_pelanggan']);
...
// Query data (matching the logic from riwayat.php)
$no = 1;
...
// Create a conditions array to collect all WHERE conditions (same as riwayat.php)
$conditions = [];
...
// This is the key addition to match riwayat.php logic
