...
if (isset($_POST['simpan'])) {
  $nama = mysqli_real_escape_string($koneksi, $_POST['nama_222146']);
  $alamat = mysqli_real_escape_string($koneksi, $_POST['alamat_222146']);
  $telepon = mysqli_real_escape_string($koneksi, $_POST['no_hp_222146']);
  $username = mysqli_real_escape_string($koneksi, $_POST['username_222146']);
  $password = md5($_POST['password_222146']);
  
  // Check if username already exists
  $check = mysqli_query($koneksi, "SELECT * FROM pengguna_222146 WHERE username_222146='$username'");
  ...
  // Insert new data
  $insert = mysqli_query($koneksi, "INSERT INTO pengguna_222146 (
              nama_222146, 
              alamat_222146, 
              no_hp_222146, 
              username_222146, 
                  ...
                  <div class="card-body">
                    <form class="forms-sample" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_222146" id="nama" placeholder="Nama" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="no_hp_222146" id="telepon" placeholder="No Hp" required>
                      </div>
                      <div class="form-group">
