...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2025 at 01:48 AM
...
--
ALTER TABLE `cicilan_222146`
  MODIFY `id_cicilan_222146` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `detail_cicilan_222146`
--
ALTER TABLE `detail_cicilan_222146`
  MODIFY `id_detail_cicilan_222146` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
...
--
ALTER TABLE `transaksi_222146`
  MODIFY `id_transaksi_222146` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
