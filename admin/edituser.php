...
if(isset($_GET['hal'])){
    if($_GET['hal'] == "edit"){
        $tampil = mysqli_query($koneksi, "SELECT * FROM admin_222146 WHERE id_admin_222146 = '$_GET[id]'");
        $data = mysqli_fetch_array($tampil);
        if($data){
            $id_admin = $data['id_admin_222146'];
            $nama_admin = $data['nama_222146'];
            $username_admin = $data['username_admin_222146'];
            $email_admin = $data['email_admin_222146'];
        }
    }
}
...
if (isset($_POST['simpan'])) {
    ...
    if(!empty($_POST['password_admin_222146'])) {
        $password = md5($_POST['password_admin_222146']);
        $update_password = ", password_admin_222146 = '$password'";
    } else {
        $update_password = "";
    }
    
    $simpan = mysqli_query($koneksi, "UPDATE admin_222146 SET
                                    nama_222146 = '$_POST[nama_222146]',
                                    username_admin_222146 = '$_POST[username_admin_222146]',
                                    email_admin_222146 = '$_POST[email_admin_222146]'
                                    $update_password
                                  WHERE id_admin_222146 = '$_GET[id]'");
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_222146" id="nama_222146" placeholder="Nama" value="<?= isset($nama_admin) ? $nama_admin : '' ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="username_admin_222146">Username</label>
                            <input type="text" class="form-control" name="username_admin_222146" id="username_admin_222146" placeholder="Username" value="<?= isset($username_admin) ? $username_admin : '' ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="password_admin_222146">Password (Kosongkan jika tidak ingin mengubah)</label>
                            <input type="password" class="form-control" name="password_admin_222146" id="password_admin_222146" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="email_admin_222146">Email</label>
                            <input type="email" class="form-control" name="email_admin_222146" id="email_admin_222146" placeholder="Email" value="<?= isset($email_admin) ? $email_admin : '' ?>" required>
                        </div>
                        <button type="submit" name="simpan" class="btn btn-primary me-2">Simpan Perubahan</button>
