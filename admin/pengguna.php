...
if(isset($_GET['hal']) == "hapus"){
    ...
    $hapus = mysqli_query($koneksi, "DELETE FROM pengguna_222146 WHERE id_pengguna_222146 = '$_GET[id]'");
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table display" id="example" style="width:100%">
                        ...
                        <?php
                          $no = 1;
                          $tampil = mysqli_query($koneksi, "SELECT * FROM pengguna_222146 ORDER BY id_pengguna_222146 DESC");
                          while($data = mysqli_fetch_array($tampil)):
                        ?>
                            <tr>
                                <td><?php echo $no++; ?></td>
                                <td><?php echo $data['nama_222146']; ?></td>
                                <td><?php echo $data['username_222146']; ?></td>
                                <td><?php echo $data['alamat_222146']; ?></td>
                                <td><?php echo $data['no_hp_222146']; ?></td>
                                <td>
                                    <a class="badge badge-warning text-decoration-none" href="editpengguna.php?hal=edit&id=<?php echo $data['id_pengguna_222146']; ?>">Edit</a>
                                    <a class="badge badge-danger text-decoration-none" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?')" href="pengguna.php?hal=hapus&id=<?php echo $data['id_pengguna_222146']; ?>">Hapus</a>
                                </td>
                            </tr>
                        <?php
                          endwhile; 
