              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table class="table display" id="example" style="width:100%">
                    ...
                    // Jika yang login adalah agen (bukan admin), tambahkan filter id_agen
                    if(isset($_SESSION['id_agen'])) {
                        $id_agen = $_SESSION['id_agen'];
                        $query .= " WHERE pr.id_agen_222146 = '$id_agen'";
                    }
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <strong>Agen:</strong> <?= $property_data['nama_agen_222146'] ?></p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
