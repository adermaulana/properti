                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($detail['status_222146'] == 'menunggu verifikasi') { ?>
                                                    <button class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#verifyModal<?= $detail['id_detail_cicilan_222146'] ?>">
                                                        Verifikasi
                                                    </button>
                                                    
                                                    <!-- Verification Modal -->
                                                    <div class="modal fade" id="verifyModal<?= $detail['id_detail_cicilan_222146'] ?>" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">Verifikasi Pembayaran Angsuran #<?= $detail['angsuran_ke_222146'] ?></h5>
                                                                ...
                                                                <form action="verify_payment.php" method="post">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <a href="../pelanggan/bukti_pembayaran/<?= $detail['bukti_pembayaran_222146'] ?>" target="_blank" class="btn btn-sm btn-info mt-2">Lihat Bukti</a>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <?php } elseif($detail['status_222146'] == 'lunas') { ?>
